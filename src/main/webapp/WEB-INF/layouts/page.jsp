...
<html>
	<head>
		...
		<link rel="stylesheet" href="<c:url value="/resources/intuit/intuit.css" />" type="text/css" media="screen" />
	</head>
	<body>
		<div id="header">
			<h1><a href="<c:url value="/"/>">APS Intuit Demo</a></h1>
		</div>
